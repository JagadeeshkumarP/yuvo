...
progressBar=findViewById(R.id.progress1);
        ...
        doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                String temp = task.getResult().getString("customlink");
                if(sp==1)
                    temp = task.getResult().getString("customlinktm");
                webView.setVisibility(View.INVISIBLE);
                ...
                if (!isConnected(getApplication())) {
                    webView.setVisibility(View.INVISIBLE);
                    if(sp==1)
                        Toast.makeText(CustomActivity.this, "இணையம் இல்லை ", Toast.LENGTH_SHORT).show();

                    else
                        Toast.makeText(CustomActivity.this, "You are offline ", Toast.LENGTH_SHORT).show();
    ...
    private class MyBrowser extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            //Toast.makeText(CustomActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            handler.proceed();
        }
        ...
        public void onPageFinished(WebView view, String url){
            ...
            doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                @Override
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    String temp1 = task.getResult().getString("customjs");
                    //Toast.makeText(CustomActivity.this, m, Toast.LENGTH_SHORT).show();
