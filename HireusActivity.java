...
public class HireusActivity extends AppCompatActivity {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hireus);
        ...
        webView.setWebViewClient(new HireusActivity.MyBrowser(getTitleColor()));
        text2=findViewById(R.id.textView);
        if(sp==1){
            text.setText("காத்திருங்கள்");
            text2.setText("HIRE US");
        ...
        doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                String temp = task.getResult().getString("hireuslink");
                if(sp==1)
                    temp = task.getResult().getString("hireuslink");
                webView.setVisibility(View.INVISIBLE);
                ...
                if (!isConnected(getApplication())) {
                    webView.setVisibility(View.INVISIBLE);
                    if(sp==1)
                        Toast.makeText(HireusActivity.this, "இணையம் இல்லை ", Toast.LENGTH_SHORT).show();

                    else
                        Toast.makeText(HireusActivity.this, "You are offline ", Toast.LENGTH_SHORT).show();
    ...
    private class MyBrowser extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
           // Toast.makeText(HireusActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            handler.proceed();
        }
        ...
        public void onPageFinished(WebView view, String url){
            ...
            doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                @Override
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    String temp1 = task.getResult().getString("hireusjs");
