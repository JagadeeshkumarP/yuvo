...
public class GodownActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                String temp = task.getResult().getString("godownlink");
                if(sp==1)
                    temp = task.getResult().getString("godownlinktm");
                webView.setVisibility(View.INVISIBLE);
                ...
                if (!isConnected(getApplication())) {
                    webView.setVisibility(View.INVISIBLE);
                    if(sp==1)
                        Toast.makeText(GodownActivity.this, "இணையம் இல்லை ", Toast.LENGTH_SHORT).show();

                    else
                        Toast.makeText(GodownActivity.this, "You are offline ", Toast.LENGTH_SHORT).show();
    ...
    private class MyBrowser extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            Toast.makeText(GodownActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            handler.proceed();
        }
        ...
        public void onPageFinished(WebView view, String url){
            ...
            doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                @Override
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    String temp1 = task.getResult().getString("godownjs");
                    //Toast.makeText(GodownActivity.this, m, Toast.LENGTH_SHORT).show();
