...
public class CostFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=LayoutInflater.from(getContext()).inflate(R.layout.fragment_cost, container, false);
        ...
        doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                String temp = task.getResult().getString("pricelink");
                String temp1 = task.getResult().getString("pricelinktm");
                ...
                webView.setWebViewClient(new WebViewClient()
                {
                    ...
                    public void onPageFinished(WebView view, String url){
                        ...
                        doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                            @Override
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                String temp1 = task.getResult().getString("pricejs");
                                try{int color= getActivity().getTitleColor();
                                ...
                                if (!isConnected(getActivity())) {
                                    ...
                                    try{if(sp==0)Toast.makeText(getActivity(), "You are offline ", Toast.LENGTH_SHORT).show();
                                    else
