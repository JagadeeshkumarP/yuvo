...
public class SchemesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                String temp = task.getResult().getString("schemeslink");
                if(sp==1)
                    temp = task.getResult().getString("schemeslinktm");
                webView.setVisibility(View.INVISIBLE);
                ...
                if (!isConnected(getApplication())) {
                    webView.setVisibility(View.INVISIBLE);
                    if(sp==1)
                        Toast.makeText(SchemesActivity.this, "இணையம் இல்லை ", Toast.LENGTH_SHORT).show();

                    else
                        Toast.makeText(SchemesActivity.this, "You are offline ", Toast.LENGTH_SHORT).show();
    ...
    private class MyBrowser extends WebViewClient {
        ...
        public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
            Toast.makeText(SchemesActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
            handler.proceed();
        }
        ...
        public void onPageFinished(WebView view, String url){
            ...
            doc.get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                @Override
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    String temp1 = task.getResult().getString("schemesjs");
                    //Toast.makeText(SchemesActivity.this, m, Toast.LENGTH_SHORT).show();
